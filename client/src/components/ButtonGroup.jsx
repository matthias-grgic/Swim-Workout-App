...
export default function ButtonSection({ currentWOD }) {
    ...
    return (
        <ButtonGroup>
            <ButtonLeft>
                <svg height="22px" viewBox="0 0 24 24" role="img" xmlns="http://www.w3.org/2000/svg" aria-labelledby="favouriteIconTitle" stroke="#1875d1" stroke-width="1" stroke-linecap="square" stroke-linejoin="miter" fill="none" color="#000000">
