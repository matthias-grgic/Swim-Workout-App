...
export default function SimpleAccordion({ name, type, equipment, video, text, id, DeleteButtonCSS }) {
    ...
    return (
        <div>
            <Accordion expanded={expandedAccordion} onChange={() => setExpandedAccordion((status) => !status)} id={id} TransitionProps={{ unmountOnExit: true }} sx={{ backgroundColor: "rgba(255,255,255, 0.3)", boxShadow: "none" }}>
