    ...
    return (
        <NavBar>
            ...
            <StyledNavLink to="/ExerciseList">
                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 472.635 472.635">
                    <path d="M0 112.293v262.305l206.502-131.153zM247.039 364.726h225.595v19.692H247.039zM247.039 272.576h225.595v19.692H247.039zM247.039 180.396h225.595v19.692H247.039zM247.039 88.216h225.595v19.692H247.039z" />
                </svg>
            </StyledNavLink>
            ...
            <StyledNavLink to="/Settings">
                ...
                <svg width="38px" height="38px" viewBox="0 0 52 52" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
